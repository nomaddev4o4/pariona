...
CREATE TABLE "product_customizations" (
	...
	"class_prefix" text,
	"product_id" uuid NOT NULL,
	"location_message" text DEFAULT 'Hey! It looks you are from <b>{country}</b>. We support Parity Purchasing Power, so if you need it, use code <b>{coupon}</b> to get <b>{discount}%</b> off.' NOT NULL,
...
CREATE INDEX "user_subscription.stripe_customer_id_index" ON "user_subscription" USING btree ("stripe_cutomer_id");